        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualquerCoisa = table.Column<int>(type: "int", nullable: false),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Estacionar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Estacionar_Estacionamento_EstacionamentoId",
                        column: x => x.EstacionamentoId,
                        principalTable: "Estacionamento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Estacionar_Usuario_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuario",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Estacionar_Veiculo_VeiculoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estacionar_EstacionamentoId",
                table: "Estacionar",
                column: "EstacionamentoId");

            migrationBuilder.CreateIndex(
                name: "IX_Estacionar_UsuarioId",
                table: "Estacionar",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Estacionar_VeiculoId",
                table: "Estacionar",
                column: "VeiculoId");
